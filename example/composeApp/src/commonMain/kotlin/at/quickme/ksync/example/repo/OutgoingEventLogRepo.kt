...
interface OutgoingEventLogRepo : CrudRepository<OutgoingEventLog>{
    @Query("select sequence, event_serialized from outgoing_event_log o left join base_event_log b on o.sequence = b.sequence where b.sequence is null and 1 = :p1")
